...
class BatchPredictor:
    ...
    def __init__(self, config_path: str = None):
        ...
        # Try to import LSTM predictor if available
        self.lstm_available = self._check_lstm_availability()
        
        logger.info(f"Batch Predictor initialized")
        logger.info(f"  LSTM Available: {self.lstm_available}")
    ...
    def _lstm_prediction(self, symbol: str, hist: pd.DataFrame) -> Dict:
        """LSTM model prediction (placeholder for now)"""
