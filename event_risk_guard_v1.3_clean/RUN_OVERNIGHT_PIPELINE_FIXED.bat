@echo off
REM Event Risk Guard - Run Overnight Pipeline (FIXED)
REM Executes the complete overnight screening with proper Python imports
...
REM Run using the wrapper script for proper imports
