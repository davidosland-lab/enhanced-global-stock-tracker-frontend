...
def diagnose_trading_logic():
    ...
    print()
    print("[ERROR] PROBLEM: Signal format mismatch!")
    ...
    print()
    print("Result:")
    print("  [OK] Trades CAN go through (prediction==1 check works)")
    print("  [X] But bypass sentiment gates (line 806 exits early)")
    print("  [X] But bypass entry timing (line 817 never runs)")
    print()
    ...
    print()
    print("Impact of Fix:")
    print("  [OK] Sentiment gates will work correctly")
    print("  [OK] Entry timing will check properly")
    print("  [OK] Trades will be blocked/reduced based on conditions")
    print()
