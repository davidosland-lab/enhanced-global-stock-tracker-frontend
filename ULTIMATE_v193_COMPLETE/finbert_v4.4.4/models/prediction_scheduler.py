...
class PredictionScheduler:
    ...
    def start(self):
        ...
        logger.info("[OK] Prediction scheduler started with jobs for US/AU/UK markets")
    ...
    def _schedule_us_validation(self):
        ...
        self.jobs['US'] = job
        logger.info("[OK] Scheduled US market validation: Daily at 16:15 EST (Mon-Fri)")
    ...
    def _schedule_au_validation(self):
        ...
        self.jobs['AU'] = job
        logger.info("[OK] Scheduled AU market validation: Daily at 16:15 AEDT (Mon-Fri)")
    ...
    def _schedule_uk_validation(self):
        ...
        self.jobs['UK'] = job
        logger.info("[OK] Scheduled UK market validation: Daily at 16:45 GMT (Mon-Fri)")
    ...
    def _validate_us_predictions(self):
        ...
        try:
            ...
            if us_preds:
                ...
                logger.info(f"[OK] Validated {result.get('validated_count', 0)} US predictions")
    ...
    def _validate_au_predictions(self):
        ...
        try:
            ...
            if au_preds:
                ...
                logger.info(f"[OK] Validated {len(au_validated)} Australian predictions")
    ...
    def _validate_uk_predictions(self):
        ...
        try:
            ...
            if uk_preds:
                ...
                logger.info(f"[OK] Validated {len(uk_validated)} UK predictions")
