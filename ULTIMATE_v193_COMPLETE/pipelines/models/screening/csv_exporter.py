...
class CSVExporter:
    ...
    def export_event_risk_summary(self, opportunities: List[Dict], filename: str = None) -> str:
        ...
        logger.info(f"[OK] Event risk summary exported: {csv_path}")
        return str(csv_path)
    ...
    opportunities = [
        {
            ...
            'event_warning': '[!] REGULATORY: Basel III report in 2 days (risk: 0.85). Recommend SKIP.',
