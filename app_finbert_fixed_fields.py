...
def get_stock_data(symbol):
    """Get current stock data with FIXED field names"""
    try:
        ...
        # FIX: Return field names that frontend expects
        response = {
            'symbol': symbol.upper(),
            'current_price': data.get('price', 0),  # FIXED: was 'price'
            'price_change': data.get('change', 0),  # FIXED: was 'change'
            'price_change_percent': data.get('changePercent', 0),  # FIXED: was 'changePercent'
            'volume': data.get('volume', 0),
            'day_high': data.get('high', data.get('price', 0)),  # FIXED: was 'high'
            'day_low': data.get('low', data.get('price', 0)),  # FIXED: was 'low'
            'chart_data': data.get('chartData', []),  # FIXED: was 'chartData'
