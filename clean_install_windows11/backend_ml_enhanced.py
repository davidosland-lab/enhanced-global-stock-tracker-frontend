...
async def health():
    ...
    return {
        ...
        "models_available": ["lstm", "gru", "random_forest", "xgboost", "transformer", "gnn", "tft", "ensemble"]
    }
...
async def predict(request: PredictionRequest):
    ...
    try:
        ...
        ensemble_price = features.get("last_price") or 0  # Must have real price
        if not ensemble_price:
...
if __name__ == "__main__":
    import uvicorn
    logger.info("Starting Enhanced ML Backend on port 8003")
