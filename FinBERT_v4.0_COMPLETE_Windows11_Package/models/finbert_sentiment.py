...
class FinBERTSentimentAnalyzer:
    ...
    def __init__(self, model_name: str = "ProsusAI/finbert"):
        ...
        # DO NOT load model at initialization - use lazy loading
        # Model will be loaded on first use to avoid startup delays/errors
    ...
    def analyze_text(self, text: str) -> Dict:
        ...
        if FINBERT_AVAILABLE and not self.is_loaded and not self.use_fallback:
            logger.info("FinBERT model not loaded yet. Loading on first use...")
            self._load_model()
        
        # Use FinBERT if available and loaded
