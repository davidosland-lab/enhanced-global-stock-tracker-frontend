...
if os.path.exists('.'):
    ...
    async def serve_dashboard():
        ...
        if os.path.exists('integrated_dashboard.html'):
            return FileResponse('integrated_dashboard.html')
        return {"message": "Dashboard not found. Please check installation."}
    
    @app.get("/single_stock_tracker.html")
    async def serve_tracker():
        """Serve the single stock tracker"""
        if os.path.exists('single_stock_tracker.html'):
            return FileResponse('single_stock_tracker.html')
        return {"message": "Tracker not found. Please check installation."}

if __name__ == "__main__":
    import uvicorn
    print("\n" + "="*60)
    print("GSMT Enhanced ML Backend Server")
    print("="*60)
    print("Server starting on: http://localhost:8000")
    print("Dashboard: http://localhost:8000/")
    print("Stock Tracker: http://localhost:8000/single_stock_tracker.html")
