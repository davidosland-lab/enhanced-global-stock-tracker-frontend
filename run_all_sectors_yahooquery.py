#!/usr/bin/env python3
"""
Run Full Market Scan - yahooquery ONLY
...
log_file = f'screener_log_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log'
...
# If Windows console doesn't support UTF-8, wrap it
...
def run_full_market_scan(top_n_per_sector=10):
    ...
    try:
        ...
        logger.info(f"✓ Loaded {len(scanner.sectors)} sectors")
        logger.info("")
