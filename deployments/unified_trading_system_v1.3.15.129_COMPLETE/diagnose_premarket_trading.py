...
print("   ✓ Returns: Historical data (60-90 days)")
print("   ✓ Latest bar: Yesterday's close")
print("   → Signal CAN be generated based on historical data")
print()
print("2. fetch_current_price(symbol):")
print("   If market CLOSED:")
print("     ✓ Returns: Yesterday's close price")
print("     ✓ Not real-time (stale)")
print("   If market OPEN:")
print("     ✓ Returns: Current real-time price")
print()
print("3. generate_swing_signal() result:")
print("   ✓ Signal generated using yesterday's close")
print("   ✓ Confidence calculated on historical pattern")
print("   ✓ Entry timing uses yesterday's data")
...
if uk_report.exists():
    ...
    print(f"✓ UK morning report exists")
    ...
    if sent_index < 30:
        ...
        print(f"  ✓ Sentiment allows trading")
