...
def test_eventguard_refresh():
    ...
    for market in markets:
        ...
        try:
            ...
            if full_data:
                print(f"  ✅ Full regime data retrieved")
                print(f"\n  Details:")
