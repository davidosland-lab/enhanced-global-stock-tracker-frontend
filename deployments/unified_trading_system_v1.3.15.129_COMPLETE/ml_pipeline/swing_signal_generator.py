...
try:
    ...
    if "keras" in error_msg.lower():
        logging.warning(
            f"⚠️  Keras not installed - LSTM predictions will use fallback method (70% accuracy)\n"
    ...
    def _load_lstm_model(self, symbol: str) -> bool:
        ...
        try:
                ...
                try:
                    ...
                    if symbol in models_registry:
                        ...
                        if model_path.exists() and scaler_path.exists():
                            ...
                            logger.info(f"[LOADED] ✓ LSTM model for {symbol} (trained {trained_date}, acc={val_accuracy:.2f})")
                            return True
                        else:
            ...
            if model_path.exists() and scaler_path.exists():
                ...
                logger.info(f"[LOADED] ✓ LSTM model for {symbol} (from file, no registry)")
                return True
