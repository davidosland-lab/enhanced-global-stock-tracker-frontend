...
print(f"Trend:               {'✅ Above MA20 & MA50 (Uptrend)' if current_price > ma20 and current_price > ma50 else '⚠️  Mixed signals'}")
print()
...
if result['entry_quality'] == 'IMMEDIATE_BUY':
    print("✅ IMMEDIATE_BUY - Enter full position NOW")
elif result['entry_quality'] == 'GOOD_ENTRY':
    print("✅ GOOD_ENTRY - Enter standard position")
...
if result['entry_quality'] == 'DONT_BUY':
    ...
    print(f"  FINAL DECISION:    ✅ TRADE APPROVED at {final_position * 100:.0f}% position")
...
print("=" * 80)
print()
print("✅ Fixed signal format mismatch (now accepts prediction=1)")
print("✅ Relaxed pullback requirements (0.5-2% now acceptable)")
print("✅ Allowed higher RSI for momentum (55-75 range)")
print("✅ Lowered thresholds (GOOD_ENTRY: 50+, not 60+)")
print("✅ System still blocks obvious tops (score < 35)")
print()
