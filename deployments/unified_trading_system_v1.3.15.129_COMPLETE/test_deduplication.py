...
def test_deduplication():
    ...
    print(f"\n✅ Removed {duplicates_removed} duplicate symbols (kept highest scores)")
...
def test_no_duplicates():
    ...
    if len(deduplicated) < len(scored):
        ...
        print("\n✅ No duplicates found - all stocks unique")
...
def test_all_duplicates():
    ...
    print(f"\n✅ Removed {len(scored) - len(deduplicated)} duplicate symbols")
...
def test_top_5_impact():
    ...
    print(f"\n✅ Result: RIO.AX (87.1) now visible in top 5 (was hidden by duplicate)")
...
def main():
    ...
    if failed == 0:
        print("\n✅ ALL TESTS PASSED - Deduplication logic is correct!")
        print("\nThe algorithm will:")
