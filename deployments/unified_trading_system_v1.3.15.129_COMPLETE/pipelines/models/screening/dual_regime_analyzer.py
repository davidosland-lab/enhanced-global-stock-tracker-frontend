    ...
    def _combine_analyses(self, multi_factor: Optional[Dict], hmm: Optional[Dict]) -> Dict:
        ...
        if multi_factor and hmm:
            ...
            if self._regimes_agree(mf_regime, hmm_regime, mf_risk, hmm_risk):
                ...
                combined['trading_guidance'].append("✅ Both methods agree - high confidence signals")
            else:
        ...
        if risk < 0.10:
            combined['trading_guidance'].append("✅ Low risk environment - normal position sizing")
        elif risk < 0.25:
