#!/usr/bin/env python3
"""
Stock Analysis System with Enhanced Intraday Support
Includes multiple intraday intervals for candlestick charts
"""
...
# HTML Template with enhanced intraday controls
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Real-time market data with customizable time intervals</p>
        </div>
        ...
        <div class="chart-container">
            ...
            <canvas id="priceChart" style="height: 500px;"></canvas>
    ...
    <script>
        ...
        function drawChart(data) {
            ...
            if (data.interval === '1m' || data.interval === '2m' || data.interval === '5m') {
                timeUnit = 'minute';
            } else if (data.interval === '15m' || data.interval === '30m') {
                timeUnit = 'hour';
...
if __name__ == '__main__':
    print("=" * 60)
    print("STOCK ANALYSIS WITH INTRADAY SUPPORT")
    print("=" * 60)
    print("Features:")
    print("✓ Intraday intervals: 1m, 2m, 5m, 15m, 30m, 1h, 90m")
    print("✓ Daily/Weekly/Monthly intervals")
    print("✓ Yahoo Finance with simplified API calls")
    print("✓ Alpha Vantage fallback for intraday")
    print("✓ Technical indicators adjusted for timeframes")
    print("✓ ML predictions adapted for intraday")
    print("✓ Auto-refresh options")
    print("✓ Quick interval buttons")
    print("✓ Export to CSV")
    print("=" * 60)
