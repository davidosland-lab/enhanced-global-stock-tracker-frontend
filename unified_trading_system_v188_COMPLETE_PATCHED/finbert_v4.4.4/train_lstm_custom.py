...
def train_lstm_for_stock(symbol):
    ...
    try:
        ...
        # Training successful
        print(f"[OK] {symbol}: Training COMPLETE!")
        ...
        try:
            with open(filename, 'r') as f:
                ...
                if content.startswith('['):
                    ...
                    print(f"[OK] Loaded {len(validated_stocks)} stocks from JSON")
                    return validated_stocks
                ...
                # Plain text - one symbol per line
                    ...
                    print(f"\n[OK] Loaded {len(validated_stocks)} stocks")
                    return validated_stocks
...
def main():
    ...
    print(f"\n[OK] Successfully trained: {len(successful)}/{len(all_stocks)}")
