        ...
        try:
            ...
            if data.empty:
                logger.error(
                    ...
                    f"Parameters: start={self.start_date}, end={self.end_date}, interval={interval}. "
                    f"Possible causes: Invalid date range, symbol not found, or Yahoo Finance API issue."
                )
                return pd.DataFrame()
