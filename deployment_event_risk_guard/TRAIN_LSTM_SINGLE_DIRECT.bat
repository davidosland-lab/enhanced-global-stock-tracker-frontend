...
REM ====================================================================
REM LSTM Single Stock Training - FIXED VERSION
REM This is the corrected version that properly handles interactive input
REM ====================================================================

echo.
echo ========================================================================
echo   LSTM SINGLE STOCK TRAINING (FIXED VERSION)
echo ========================================================================
echo.
...
if "%~1"=="" (
    ...
    echo   1. Command line: TRAIN_LSTM_SINGLE_DIRECT.bat CBA.AX
...
REM Train the model using the corrected variable
echo.
echo DEBUG: About to run: python train_lstm_custom.py --symbols !SYMBOL!
echo.
