@echo off
REM ============================================================================
REM UK MARKET COMPLETE PIPELINE - WINDOWS LAUNCHER
REM ============================================================================
REM
REM Features:
...
REM
REM This script runs the complete UK Market overnight screening pipeline
...
echo.
echo ===========================================================================
echo UK MARKET COMPLETE PIPELINE v1.3.13
echo ===========================================================================
echo.
echo Market: London Stock Exchange (LSE)
...
REM   "FTSE 100 Leaders", "UK Banks", "UK Mining", "UK Energy"
REM   "UK Consumer", "UK Healthcare", "FTSE 100 Top 10"
set PRESET=FTSE 100 Leaders

REM Initial capital (GBP)
set CAPITAL=100000
...
if not exist "run_uk_full_pipeline.py" (
    echo [ERROR] run_uk_full_pipeline.py not found!
...
echo Initial Capital: £%CAPITAL% GBP
...
echo [STARTING] UK Market Complete Pipeline...
echo.
...
if "%MODE%"=="full-scan" (
    set CMD=python run_uk_full_pipeline.py --full-scan --capital %CAPITAL%
) else if "%MODE%"=="preset" (
    set CMD=python run_uk_full_pipeline.py --preset "%PRESET%" --capital %CAPITAL%
) else if "%MODE%"=="test" (
    set CMD=python run_uk_full_pipeline.py --mode test --capital %CAPITAL%
) else (
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo Log file: logs/uk_full_pipeline.log
    ...
    echo ===========================================================================
    echo.
    echo Please check logs/uk_full_pipeline.log for errors
    echo.
)
