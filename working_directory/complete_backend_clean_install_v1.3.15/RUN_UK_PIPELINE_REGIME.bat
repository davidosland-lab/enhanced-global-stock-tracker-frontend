@echo off
REM =============================================================================
REM UK PIPELINE RUNNER - REGIME INTELLIGENCE EDITION
REM =============================================================================
REM 
REM This script runs the UK Market Pipeline with full regime intelligence:
REM - 240 stocks across 8 sectors (Technology, Financials, Energy, etc.)
...
echo.
echo ================================================================================
echo          UK MARKET PIPELINE - REGIME INTELLIGENCE EDITION v1.3.13
echo ================================================================================
echo.
echo This pipeline includes:
echo   [OK] 240 UK stocks across 8 sectors
...
echo    python run_uk_pipeline_v1.3.13.py --full-scan --capital 100000
echo.
echo 2. Custom Symbols (with regime intelligence)
echo    python run_uk_pipeline_v1.3.13.py --symbols LLOY.L,BP.L,HSBA.L --capital 50000
echo.
echo 3. Without Regime Intelligence (pure fundamental scoring)
echo    python run_uk_pipeline_v1.3.13.py --full-scan --no-regime --capital 100000
echo.
echo ================================================================================
echo.
...
if "%MODE%"=="1" (
    ...
    echo [INFO] Scanning 240 UK stocks across 8 sectors
    echo.
    python run_uk_pipeline_v1.3.13.py --full-scan --capital 100000
) else if "%MODE%"=="2" (
    set /p SYMBOLS="Enter symbols (e.g. LLOY.L,BP.L,HSBA.L): "
    echo.
    echo [INFO] Running custom symbols: %SYMBOLS%
    echo.
    python run_uk_pipeline_v1.3.13.py --symbols %SYMBOLS% --capital 100000
) else if "%MODE%"=="3" (
    echo [INFO] Running FULL SECTOR SCAN WITHOUT regime intelligence
    echo.
    python run_uk_pipeline_v1.3.13.py --full-scan --no-regime --capital 100000
) else (
