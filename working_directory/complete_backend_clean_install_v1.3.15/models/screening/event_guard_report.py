...
if __name__ == "__main__":
    ...
    example_data = [
        ...
        },
        {
            ...
            'skip_trading': False,
            'hedge_beta': 0.88,
            'warning': '[!] Negative sentiment (-0.15) detected in recent news'
        },
        {
            'ticker': 'NAB.AX',
            'event_type': 'dividend',
    ...
    print("[OK] Test report generated: event_guard_test_report.html")
