            ...
            try:
                ...
                if len(hist) > 0:
                    ...
                    if len(market_hours_data) > 0:
                        ...
                        if spans_midnight:
                            # For midnight-spanning markets, get the close from 2 trading days ago
                            # to get the true "previous close" before the session started
                            from datetime import timedelta
                            two_days_ago = latest_date - timedelta(days=2)
                            previous_day_data = hist[hist.index.date <= two_days_ago]
                            
                            if len(previous_day_data) > 0:
                                # Use the last close from 2 days ago
            ...
            if morning_sentiment and 'finbert_sentiment' in morning_sentiment:
                ...
                finbert_panel = html.Div([
                    ...
                    html.Div([
                        ...
                        html.Div(style={
                            'width': f"{scores.get('negative', 0) * 100}%",
                            'height': '30px',
                            ...
                            'color': '#fff',
                            'fontWeight': 'bold'
                        }, children=f"{scores.get('negative', 0) * 100:.1f}%")
                    ...
                    html.Div([
                        ...
                        html.Div(style={
                            'width': f"{scores.get('neutral', 0) * 100}%",
                            'height': '30px',
                            ...
                            'color': '#000',
                            'fontWeight': 'bold'
                        }, children=f"{scores.get('neutral', 0) * 100:.1f}%")
                    ], style={'flex': '1', 'margin': '0 10px'}),
                    ...
                    html.Div([
                        ...
                        html.Div(style={
                            'width': f"{scores.get('positive', 0) * 100}%",
                            'height': '30px',
                            ...
                            'color': '#fff',
                            'fontWeight': 'bold'
                        }, children=f"{scores.get('positive', 0) * 100:.1f}%")
                    ], style={'flex': '1', 'margin': '0 10px'})
                ], style={'display': 'flex'})
