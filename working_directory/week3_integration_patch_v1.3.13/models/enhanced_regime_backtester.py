...
class EnhancedRegimeBacktester:
    ...
    def __init__(
        ...
        logger.info("✅ EnhancedRegimeBacktester initialized")
    ...
    def backtest_strategy(
        ...
        logger.info(f"✅ Backtest complete: {total_return:+.2f}% return, {num_trades} trades")
    ...
    def compare_strategies(
        ...
        logger.info(f"✅ Best regime weight: {best_weight} ({results[f'weight_{best_weight}']['total_return']:+.2f}%)")
...
def test_enhanced_backtester():
    ...
    print(f"\n✅ Best Strategy: {comparison['best_weight']*100:.0f}% regime weight")
