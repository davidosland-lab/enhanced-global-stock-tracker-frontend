"""
CBA.AX (Commonwealth Bank of Australia) - 2 Year Backtest
==============================================
Testing the latest ML model decision-making on Australian banking stock
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('backtest_cba_ax.log'),
...
class DROBacktestEngine:
    """Backtest engine for CBA.AX using latest model"""
    
    def __init__(self, symbol='CBA.AX', initial_capital=100000.0):
        self.symbol = symbol
    ...
    def enter_position(self, date, price, signal):
        ...
        # Position sizing: 20% of capital (standard for stable stocks)
        position_size = 0.20
        ...
        # Stop loss: 5% below entry (tighter for stable stock)
        stop_loss = price * 0.95
        
        # Take profit: 10% above entry (reasonable for bank stock)
    ...
    def run_backtest(self, start_date, end_date):
        ...
        for i in range(50, len(df)):  # Start after warm-up period
            ...
            if self.symbol not in self.positions:
                ...
                # Lowered threshold to 40 for more trading opportunities
    ...
    def print_report(self, report):
        ...
        logger.info("\n" + "=" * 80)
        logger.info("BACKTEST RESULTS - CBA.AX (Commonwealth Bank of Australia)")
        logger.info("=" * 80)
...
def main():
    ...
    # Save report to JSON
    output_file = 'backtest_cba_ax_results.json'
