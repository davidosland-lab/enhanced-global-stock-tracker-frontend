...
class ManualTradingPlatform(UnifiedTradingPlatform):
    ...
    def __init__(self, initial_capital=100000, dashboard_port=5000):
        super().__init__(
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Manual Paper Trading Platform')
    parser.add_argument(
        '--port',
        type=int,
        default=5000,
        help='Dashboard port (default: 5000, recommended for integration: 5004)'
    )
    parser.add_argument(
        '--capital',
        type=float,
    ...
    platform = ManualTradingPlatform(
