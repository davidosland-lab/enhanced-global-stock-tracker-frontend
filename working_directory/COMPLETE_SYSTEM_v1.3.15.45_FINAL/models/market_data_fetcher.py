...
class MarketDataFetcher:
    ...
    def __init__(self):
        ...
        logger.info("[OK] MarketDataFetcher initialized (REAL DATA ONLY)")
    ...
    # REMOVED: _get_mock_data() method
    # This system does NOT support mock/fake data in production.
    # All data must come from real market sources (Yahoo Finance via yahooquery).
