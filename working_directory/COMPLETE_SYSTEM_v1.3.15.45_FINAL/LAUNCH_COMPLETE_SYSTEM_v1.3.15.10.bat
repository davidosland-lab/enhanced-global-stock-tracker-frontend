@echo off
REM ═══════════════════════════════════════════════════════════════════════════
REM  COMPLETE GLOBAL MARKET INTELLIGENCE SYSTEM - SMART LAUNCHER
...
REM  - Dependency installation on first run
...
echo.
echo ═══════════════════════════════════════════════════════════════════════════
echo   COMPLETE GLOBAL MARKET INTELLIGENCE SYSTEM
echo   Smart Launcher - v1.3.15.10 (Progress Visibility + Trading Platform)
echo ═══════════════════════════════════════════════════════════════════════════
echo.
...
if exist "requirements.txt" (
    ...
    if errorlevel 1 (
        ...
        echo.
        pip install yfinance pandas numpy flask requests python-dotenv bcrypt scikit-learn
    )
) else (
...
set /p "MENU_CHOICE=Select option (1-9): "
...
if "%MENU_CHOICE%"=="7" goto :dashboard
if "%MENU_CHOICE%"=="8" goto :advanced_menu
...
echo %COLOR_BLUE%[->] Press Ctrl+C to stop trading%COLOR_RESET%
echo.

python paper_trading_coordinator.py --config-file config/live_trading_config.json

echo.
echo %COLOR_YELLOW%[!] Trading platform stopped%COLOR_RESET%
echo.
pause
goto :show_menu
...
:dashboard
REM ──────────────────────────────────────────────────────────────────────────
REM  OPTION 7: Open Trading Dashboard
REM ──────────────────────────────────────────────────────────────────────────
...
echo.
echo %COLOR_BLUE%Thank you for using the Global Market Intelligence System!%COLOR_RESET%
echo.
echo v1.3.15.10 - Progress Visibility + Trading Platform Access
echo Includes ensemble_weights fix (v1.3.15.9)
echo.
timeout /t 2 >nul
exit /b 0
