...
class EnhancedDataSources:
    ...
    def __init__(self):
        ...
        logger.info("✅ EnhancedDataSources initialized")
    ...
    def fetch_iron_ore_data(self, use_cache: bool = True) -> Dict:
        ...
        logger.info("🌐 Fetching iron ore data...")
        ...
        for method in methods:
            try:
                ...
                if data and data.get('price') is not None:
                    ...
                    logger.info(f"✅ Iron ore data fetched from {data['source']}")
                    logger.info(f"   Price: ${data['price']:.2f}/tonne, Change: {data['change_1d']:+.2f}%")
                    return data
            except Exception as e:
                logger.warning(f"⚠️ Failed to fetch from {method.__name__}: {e}")
                continue
        
        # All methods failed
        logger.error("❌ All iron ore data sources failed")
    ...
    def fetch_au_10y_yield(self, use_cache: bool = True) -> Dict:
        ...
        logger.info("🌐 Fetching AU 10Y yield data...")
        ...
        for method in methods:
            try:
                ...
                if data and data.get('yield') is not None:
                    ...
                    logger.info(f"✅ AU 10Y data fetched from {data['source']}")
        ...
        # All methods failed
        logger.error("❌ All AU 10Y data sources failed")
    ...
    def fetch_additional_indicators(self) -> Dict:
        ...
        logger.info("🌐 Fetching additional indicators...")
        ...
        try:
            ...
            logger.info(f"✅ Additional indicators fetched: {', '.join(result.keys())}")
            return result
            
        except Exception as e:
            logger.error(f"❌ Error fetching additional indicators: {e}")
            return {}
    ...
    def get_all_enhanced_data(self) -> Dict:
        ...
        logger.info("=" * 80)
        logger.info(f"✅ All enhanced data fetched in {elapsed:.3f} seconds")
        logger.info("=" * 80)
