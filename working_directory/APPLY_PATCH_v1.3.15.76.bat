@echo off
REM ===========================================================================
REM  MARKET CHART PATCH v1.3.15.76 - LINE-BASED EXTRACTION
REM  Fixed: Uses line numbers instead of regex extraction
REM ===========================================================================
...
echo.
echo ============================================================================
echo   MARKET CHART PATCH v1.3.15.76
echo ============================================================================
echo.
...
if not exist "apply_patch_standalone_v76.py" (
    echo.
    echo [ERROR] apply_patch_standalone_v76.py not found!
    echo.
    echo Please make sure you have ALL THREE files in the same folder:
    echo   1. APPLY_PATCH_v1.3.15.76.bat  ^(this file^)
    echo   2. apply_patch_standalone_v76.py
...
echo.
python apply_patch_standalone_v76.py
if errorlevel 1 (
    echo.
    echo [ERROR] Patch failed!
    echo.
    echo The backup file has been preserved.
    echo To manually restore: copy unified_trading_dashboard.py.backup_* unified_trading_dashboard.py
    echo.
    pause
    exit /b 1
)
