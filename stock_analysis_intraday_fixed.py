#!/usr/bin/env python3
"""
Stock Analysis System with Enhanced Intraday Support - FIXED VERSION
Fixes JavaScript errors and chart rendering issues
"""
...
# HTML Template with enhanced intraday controls - FIXED VERSION
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        ...
        function drawChart(data) {
            ...
            if (data.interval === '1m' || data.interval === '2m' || data.interval === '5m') {
                ...
                timeUnit = 'hour';
                displayFormat = 'HH:mm';
            } else if (data.interval === '60m' || data.interval === '1h' || data.interval === '90m') {
                timeUnit = 'hour';
...
if __name__ == '__main__':
    print("=" * 60)
    print("STOCK ANALYSIS WITH INTRADAY SUPPORT - FIXED")
    print("=" * 60)
    print("Features:")
    print("✓ JavaScript errors fixed")
    print("✓ Intraday intervals: 1m, 2m, 5m, 15m, 30m, 1h, 90m")
    print("✓ Chart.js financial plugin properly loaded")
    print("✓ Favicon 404 handled")
