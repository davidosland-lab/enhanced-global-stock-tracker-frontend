#!/bin/bash
# ============================================================================
# FAST TEST - Dual Market Screening System
# Tests only 1-2 sectors for quick validation
# ============================================================================
...
echo "  - Run: ./RUN_QUICK_TEST.sh (both markets, all sectors, ~20 min)"
echo "  - Or: ./RUN_BOTH_MARKETS.sh (production run, ~30 min)"
echo ""
