...
try:
    ...
    print("Warning: numpy import issue detected. Attempting to work around...")
    sys.modules['numpy'] = None  # Temporary workaround
    import numpy as np
...
try:
    ...
    print(f"⚠ FinBERT loading error: {e} - using fallback sentiment")
